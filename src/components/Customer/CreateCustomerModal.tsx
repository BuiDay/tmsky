...
const CreateCustomerModal: React.FC<IProps> = (props) => {
    ...
    return (
        <>
            <Modal open={isModalOpen} footer={[]} onCancel={handleCancel}>
                <h1 className="text-center font-semibold text-2xl">Create customer</h1>
                                            ...
                                            >
                                                <RangePicker onChange={onRangeChange} 
                                                    ...
                                                    showTime={{
                                                        ...
                                                        // defaultValue: [dayjs('00:00', 'HH:mm'), dayjs('11:00:00', 'HH:mm:ss')],
                                                    }} 
